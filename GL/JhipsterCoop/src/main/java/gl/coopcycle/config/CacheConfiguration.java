...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, gl.coopcycle.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, gl.coopcycle.repository.UserRepository.USERS_BY_EMAIL_CACHE);
